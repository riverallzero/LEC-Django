...
class TestView(TestCase):
    ...
    def navbar_test(self, soup):
        ...
        self.assertIn('Todo', navbar.text)
        ...
        about_me_btn = navbar.find('a', text='Todo')
        self.assertEqual(about_me_btn.attrs['href'], '/todo/')
    ...
    def test_post_list(self):
        ...
        self.assertEqual(soup.title.text, 'Do it Django')
